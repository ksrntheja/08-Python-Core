...
# ksrntheja@ksrntheja-Lenovo-IdeaPad-L340-15IWL:~/Code/venv/unittesting$ python3 -m pytest -s -v 27PyTestOrderCutomOrderZero.py
# =============================================================================================== test session starts ===============================================================================================
...
# collected 3 items
#
# 27PyTestOrderCutomOrderZero.py::test_methodC test_methodC execution
# PASSED
# 27PyTestOrderCutomOrderZero.py::test_methodA test_methodA execution
# PASSED
# 27PyTestOrderCutomOrderZero.py::test_methodB test_methodB execution
# PASSED
#
# ================================================================================================ 3 passed in 0.01s ================================================================================================
